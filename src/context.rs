...
//use websocket_server::WebsocketWrapper;
...
pub struct Context {
    ...
    //websockets: Vec<Arc<WebsocketWrapper>>
}
...
impl Context {
    ...
    pub fn notify_new_service(&self, _: &Box<Service>) {
    ...
    pub fn add_websocket(&mut self, ws: Arc<WebsocketWrapper>) {
